...
<html lang="en">
  <head>
    ...
    <title>PEKA-Beranda</title>
  </head>
  <body style="background-color: #ffbd00;">
  ...
  <div class="container-fluid" style="margin: 0;padding: 0;">
	<div class="image" style="margin-top: -21px">
		<img src="images/1.jpg" style="width: 100%;  height: 650px;">
	</div>
</div>
  <br>
    ...
    <h4 class="text-center mt-3" style="font-family: arial; padding-top: 10px; padding-bottom: 10px; font-style: italic; line-height: 29px; border-top: 2px solid #000000; border-bottom: 2px solid #000000;">Kebebasan perangkat genggam baru, sekarang Anda dapat sepenuhnya mengekspresikan visi dengan kualitas full-frame dan imbangan guncangan kamera canggih yang kompatibel dengan berbagai ragam lensa.</h4>
  ...
  <footer style="background-color: #000000; border-top: 4px solid #000000;  ">
		...
		<div class="container m-t-100" style="padding-bottom: 50px;">
			<div class="row">
				<div class="col-md-4">
					<h3 style="color: #ffffff"><b>PEKA</b></h3>
					...
					<p style="color: #ffffff"><i class="glyphicon glyphicon-earphone"></i> +6288232847289</p>
					<p style="color: #ffffff"><i class="glyphicon glyphicon-envelope"></i> bsi@gmail.com</p>
				</div>
				<div class="col-md-4">
					<h5><b></b></h5>
